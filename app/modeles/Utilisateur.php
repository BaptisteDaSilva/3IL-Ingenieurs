...
class Utilisateur extends Modele
{
    ...
    const RQT_AJOUTER_UTIL = 'INSERT INTO t_utils (login, mdp, email, type) VALUES (:login, :mdp, :email, :type)';

    /** @var string Requête SQL permettant de modifier l'email d'un utilisateur */
    const RQT_MODIFIER_MAIL_UTIL = 'UPDATE t_utils SET email = :email WHERE login = :login';

    /** @var string Requête SQL permettant de modifier le mot de passe d'un utilisateur */
    const RQT_MODIFIER_MDP_UTIL = 'UPDATE t_utils SET mdp = :mdp WHERE login = :login';

    /** @var string Requête SQL permettant de modifier l'avatar d'un utilisateur */
    const RQT_MODIFIER_AVATAR_UTIL = 'UPDATE t_utils SET idAvatar = :idAvatar WHERE login = :login';

    /** @var string Requête SQL permettant de modifier la langue d'un utilisateur */
    const RQT_MODIFIER_LANGUE_UTIL = 'UPDATE t_utils SET idLangue = :idLangue WHERE login = :login';
    ...
    public function modifierLangue($nomLangue)
    {
        ...
        $idLangue = Langue::getIdLangue($nomLangue);
