<?php
    ...
    class Ville extends Modele {
         ...
         * @param Departement $dep le département de la ville.
         * @param string $nom le nom de la ville.
         * @param string $cp le code postal de la ville.
         * @param int $population le nombre d'habitants de la commune.
         * @param int $densite la densité de la commune.
         * @param float $superficie la superficie de la commune.
         * @param int $altMax l'altitude maximum de la commune.
         * @param int $altMin l'altitude minimum de la comune.
         * @param int $latitude la latitude de la commune.
         * @param int $longitude la longitude de la commune.
         * @param string $desc la description de la commune.
         */
        public function __construct($numInsee, $nom, Departement $dep = null,
            $cp = null, $population = null, $densite = null,
            $superficie = null, $altMax = null, $altMin = null,
            $latitude = null, $longitude = null, $desc = null, $photos = null) {
         ...
         * @param $numInsee string le numéro INSEE de la ville.
        ...
        public static function getVille($numInsee) {
            ...
            return $ville ? new Ville($ville->numinsee,
                                      $ville->nomville,
                                       new Departement($ville->numdep,
                                                       $ville->nomdep),
                                       $ville->cp,
                                       $ville->population,
                                       $ville->densite,
         ...
         * argument.
         * @param $ville Ville la ville dont on veut connaître les villes
         * proches.
        ...
        public static function modifierVille($numInsee, $population, $densite,
            $superficie, $altMin, $altMax, $longitude, $latitude, $desc) {
