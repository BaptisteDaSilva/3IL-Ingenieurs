<?php
    ...
    class Region extends Modele {
        ...
        /**
         * Créé une région.
         * @param string $numReg le numéro de la région.
         * @param string $nomReg le nom de la région.
         * @param Ville $chefLieu le chef-lieu de la région.
         * @param array $deps la liste des départements de la région.
         * @param string $desc la description de la région.
         */
        public function __construct($numReg, $nomReg, Ville $chefLieu = null,
            array $deps = null, $desc = null) {
            $this->numReg = $numReg;
            $this->nomReg = $nomReg;
         ...
         * @param $numReg string le numéro de la région.
        ...
        public static function getRegion($numReg) {
            ...
            return $reg ? new Region($reg->numreg, $reg->nomreg,
                                     new Ville($reg->numinsee, $reg->nomcheflieu),
                                     $deps, $reg->des) : null;
        }
