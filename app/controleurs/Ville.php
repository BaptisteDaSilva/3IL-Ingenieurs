...
use Rodez_3IL_Ingenieurs\modeles\PhotoVille;
...
class Ville extends Controleur
{
     ...
     *            le numéro INSEE de la ville dont on veut
    ...
    public function details($numInsee)
    {
        if (isset($numInsee)) {
            ...
            if (isset($this->ville)) {
                ...
                $this->villesProches = Modeles\Ville::getVillesProches($this->ville);
                $config = parse_ini_file(CONFIG);
                $nbPhotos = $config['nbPhotosVilles'];
                $this->photosVille = PhotoVille::getPhotosVille($this->ville, $nbPhotos);
    ...
    {
        if (isset($numInsee) && isset($_POST['population']) && isset($_POST['densite']) && isset($_POST['superficie']) && isset($_POST['altMin']) && isset($_POST['altMax']) && isset($_POST['long']) && isset($_POST['lat']) && isset($_POST['desc'])) {
            
            $this->modifOK = Modeles\Ville::modifierVille($numInsee, $_POST['population'], $_POST['densite'], $_POST['superficie'], $_POST['altMin'], $_POST['altMax'], $_POST['long'], $_POST['lat'], $_POST['desc']);
