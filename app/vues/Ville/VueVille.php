                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        for ($i = 0 ; $i < count($this->villesProches) ; $i++) {
                            echo '<tr>';
                            echo '<td><a href="/GeoVilles/ville/details/'
                                 . $this->villesProches[$i]->getNumInsee() .
                                 '">' .
                                 $this->villesProches[$i]->getNom() .
                                 '</a></td>';
                            echo '</tr>';
                        }
                        ?>
                    ...
                    <h3 class="panel-title"><?= $this->ville->getNom() ?>
                        <?php
                            if (isset($_SESSION['util'])) {
                                echo '<a
                                href="/GeoVilles/ville/modifier/' .
                                     $this->ville->getNumInsee() . '/" class="btn
