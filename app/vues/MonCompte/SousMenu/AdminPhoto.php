...
<div id="panel_adminPhoto" class="panel-body panel-photo">
	<div class="row">
		...
		<div class="col-md-8">
            ...
            <form method="post" action="/Administration/supprimerPhoto/">
                ...
                <?php foreach ($this->photos as $photo) { $pName = Photo::getName($photo); ?>
                    <div class="photo">
						...
						<p>
							<input id="supp<?= $pName ?>" type="checkbox" name="aSupp[]"
								value="<?= $pName ?>"> <label for="supp<?= $pName ?>"><?= $pName ?></label>
						</p>
					</div>
                <?php } ?>        
                </div>
			...
			<form method="post" action="/Administration/ajouterPhoto/"
				enctype="multipart/form-data">
				<div class="form-group">
					<div class="photoView">
						<img id="photoView" src="<?= DEFAUT_IMAGE ?>" alt="Default image"
							class="photoView" />
					</div>
