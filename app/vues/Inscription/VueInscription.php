		...
		<div class="col-md-8">
            <?php if ($this->inscriptionOK) { ?>
                <div class="panel panel-success bigPanel">
                    ...
                    <div class="panel-body">
                        Votre inscription s'est déroulée avec succès.<br>
                        Vous pouvez maintenant vous connecter avec vos
                        identifiants.<br>
                        Merci.
                    </div>
            	</div>
            <?php } else { ?>
                <div class="panel panel-danger bigPanel">
                    ...
                    <div class="panel-body">
                        Un problème est survenu lors de votre inscription.<br>
                        Merci de réessayer de vous inscrire avec des identifiants
                        différents.
                    </div>
            	</div>
            <?php } ?>
