    ...
    <div class="col-md-8"> 
        ...
        <form method="post" action="/Administration/ajouterLangue/" enctype="multipart/form-data">
            <div class="form-group">
                <input id="id" type="text" class="form-control" name="id" placeholder="<?= self::get('Administration', 'Placeholder', 'CodeLangue') ?>" maxlength="2" required>
            </div>
            <div class="form-group">
                <input id="nom" type="text" class="form-control" name="nom" placeholder="<?= self::get('Administration', 'Placeholder', 'NomLangue') ?>" maxlength="20" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="propertie"><?= self::get('Administration', 'Libelle', 'FichierProperties') ?><a href="/Administration/defaultProperties/"><?= self::get('Administration', 'Libelle', 'ARemplir') ?></a></label>
