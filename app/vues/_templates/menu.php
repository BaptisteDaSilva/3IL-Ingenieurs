    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <img src="<?= IMAGES . 'ico.png' ?>">&nbsp;&nbsp;&nbsp;<?= Application::$site->{'Titre'} ?></a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li <?php if ($this->getActivePage() == 'Accueil') { echo 'class="active"'; } ?>>
                    <a href="/">
                        <i class="fa fa-home"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Accueil'} ?><span
                ...
                <li class="dropdown <?php if ($this->getActivePage() == 'Formation') { echo 'active'; } ?>">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="/Formation">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Form'}->{'Presentation'} ?></a>
                        </li>
                        <li>
                            <a href="/Formation/annee1">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Form'}->{'Annee1'} ?></a>
                        </li>
                        <li>
                            <a href="/Formation/annee2">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Form'}->{'Annee2'} ?></a>
                        </li>
                        <li>
                            <a href="/Formation/annee3">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Form'}->{'Annee3'} ?></a>
                        </li>
                    </ul>
                </li>
                <li <?php if ($this->getActivePage() == 'Apprentissage') { echo 'class="active"'; } ?>>
                    <a href="/Apprentissage">
                        <i class="fa fa-file"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Apprentissage'} ?>
				</a>
                </li>
                <li <?php if ($this->getActivePage() == 'Rodez') { echo 'class="active"'; } ?>>
                    <a href="/Rodez">
                        <i class="fa fa-flag"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Rodez'} ?>
				</a>
                </li>
                <li <?php if ($this->getActivePage() == 'Contact') { echo 'class="active"'; } ?>>
                    <a href="/Contact">
                        <i class="fa fa-pencil"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'Contact'} ?>
				</a>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if (isset($_SESSION['util'])) { ?>
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="/MonCompte">
                                <i class="fa fa-gears"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'MonCompte'} ?></a>
                        </li>
                        <li>
                            <a href="/Deconnexion">
                                <i class="fa fa-power-off"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'SeDeconnecter'} ?></a>
                        </li>
                    </ul>
                </li>
                <?php } else { ?>
                        ...
                        <li>
                            <form id="form-inscrire" class="form-inscrire" method="post" action="/Inscription">
                                ...
                                <input type="submit" name="submit" class="btn
                                    mon-btn"
                                    disabled value="<?= Application::$site->{'Menu'}->{'SInscrire'} ?>">
                            </form>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false">
                        <i class="fa fa-user"></i>&nbsp;&nbsp;<?= Application::$site->{'Menu'}->{'SeConnecter'} ?><span
                            class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
